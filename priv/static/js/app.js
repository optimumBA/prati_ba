...
if (_socket__WEBPACK_IMPORTED_MODULE_5__["default"]) {
  var analytics = new _analytics__WEBPACK_IMPORTED_MODULE_6__["default"](_socket__WEBPACK_IMPORTED_MODULE_5__["default"]);
  analytics.track();
}
...
if (window.analyticsToken) {
  socket = new phoenix__WEBPACK_IMPORTED_MODULE_0__["Socket"]("/socket", {
    params: {
      token: window.analyticsToken
    }
  });
  socket.connect();
