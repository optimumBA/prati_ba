...
RUN apt-get update -y && apt-get install -y build-essential curl git npm \
...
RUN apt-get update -y && apt-get install -y imagemagick libstdc++6 openssl libncurses5 locales \
  && apt-get clean && rm -f /var/lib/apt/lists/*_*
