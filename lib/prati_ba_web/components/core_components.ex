defmodule PratiBaWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PratiBaWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PratiBaWeb.Gettext, "errors", msg, opts)
    end
  end
